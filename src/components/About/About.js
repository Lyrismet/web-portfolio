        ...
        <div id="about" className={styles.about}>
            <div className={styles.aboutInfo}>
                ...
                <p className={styles.text}>
                    ...
                    of experienced developers. In my spare time I like to study psychology, which allows me to have more <span>harmonious</span> relationships with my colleagues and increase my <span>productivity</span>
                    .
                </p>
            </div>
